...
import com.charles.cursojava.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		Categoria cat0 = new Categoria(null,"Escritorio");
		Categoria cat1 = new Categoria(null,"Informatica");
		Categoria cat2 = new Categoria(null,"Cama");
		Categoria cat3 = new Categoria(null,"mouse");
		Categoria cat4 = new Categoria(null,"aaaaaa");
		Categoria cat5 = new Categoria(null,"bbbb");
		Categoria cat6 = new Categoria(null,"ccccc");
		Categoria cat7 = new Categoria(null,"ddd");
		Categoria cat8 = new Categoria(null,"wwwwwww");
		Categoria cat9 = new Categoria(null,"pppppp");
		...
		categoriaRepository.saveAll(Arrays.asList(cat0,cat1,cat2,cat3,cat4,cat5,cat6,cat7,cat8,cat9));
		...
		Cliente cli1 = new Cliente(null, "Isabela Silva", "charlescostas@gmail.com","02483451926",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","54564654"));
		
		Cliente cli2 = new Cliente(null, "Davi Silva", "charles@procedsystem.com.br","00000000191",TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27363323","54564654"));
